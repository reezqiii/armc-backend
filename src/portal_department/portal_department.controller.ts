...
export class PortalDepartmentController {
  constructor(private readonly portalDepartmentService: PortalDepartmentService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePortalDepartmentDto: UpdatePortalDepartmentDto) {
